...
namespace CompanyEmployeesBalancing.Test.Core
{
    ...
    //    {
    //        _balanceService = DependencyResolver.Get<Balance>();
    ...
    //    {
    //        var company = new Company();
    //        CompanyOrganization.Domain.BusinessObjects.Team team1 = CreateTeamFourExtraMaturity();
    ...
    //        CompanyOrganization.Domain.BusinessObjects.Team team3 = CreateTeamWithDiferentsEmployeesMaturity();
    ...
    //        var employeesTeam3 = new List<CompanyOrganization.Domain.BusinessObjects.Employee>();
