...
namespace CompanyEmployeesBalancing.Test.Core
{
    ...
    //{
    //    private readonly CompanyOrganization.Implementation.Command _commandService;
    //    private readonly CompanyOrganization.Implementation.Team _teamService;

    //    public CommandServiceTest()
    //    {
    //        _commandService = DependencyResolver.Get<CompanyOrganization.Implementation.Command>();
    ...
    //        Assert.AreEqual(CompanyOrganization.Enumeration.CommandEnum.Allocate, command.Command);
    ...
    //        Assert.AreEqual(CompanyOrganization.Enumeration.CommandEnum.Balance, command.Command);
    //        Assert.AreEqual(0, command.Arguments.Count);
    //    }
    ...
    //        Assert.AreEqual(CompanyOrganization.Enumeration.CommandEnum.Load, command.Command);
    ...
    //    {
    //        var command = _commandService.GetCommand("promote 3");
    //        Assert.AreEqual(CompanyOrganization.Enumeration.CommandEnum.Promote, command.Command);
    ...
    //        var command = Builder<CommandDto>
    //            .CreateNew()
    //            .With(c => c.Command = CompanyOrganization.Enumeration.CommandEnum.Allocate)
    //            .Build();
    ...
    //        var command = Builder<CommandDto>
    //            .CreateNew()
    //            .With(c => c.Command = Command.Promote)
    //            .With(c => c.Arguments = arguments)
    //            .Build();
    //        _commandService.ExecuteCommand(command);
    ...
    //        var command = Builder<CommandDto>
    //            .CreateNew()
    //            .With(c => c.Command = CompanyOrganization.Enumeration.CommandEnum.Balance)
    //            .Build();
    //        _commandService.ExecuteCommand(command);
